...
public class Constants {
    ...
    public static final String INDEX_PATH_WITH_NER_V2 = "nerIndex/";
    
    public static final String INDEX_PATH = INDEX_PATH_WITH_NER_V2; /* set it to whatever folder index must be stored in*/
    ...
    public static final int CONTENT_QUERY_LENGTH = 80; // 80 good
    ...
    public static final boolean VECTOR_NEEDED = true;
