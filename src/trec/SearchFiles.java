...
public class SearchFiles {
	...
	public static void main(String[] args) {
		...
		String str = "ORGANIZATION/Terps PERSON/Greg Gattuso LOCATION/Albany ";
		PhraseQuery phraseQuery = new PhraseQuery(0,"titlener",str);
		   

		   
		Query query = null;
		try {
			query = parser.parse("somestr");
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		ScoreDoc[] hits = null;
		try {
			hits = isearcher.search(phraseQuery, 1).scoreDocs;
		} catch (IOException e) {
			e.printStackTrace();
		}
