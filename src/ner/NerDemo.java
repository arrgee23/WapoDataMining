    ...
    */
    ...
    if (args.length > 1) {
      ...
      */
      ...
      String[] example = {"stanford university",
                          "This is a good dog. I went to visit harvard unniversity with Albert. I go to school at stanford university, which is located in california." };
      ...
      for (String str : example) {
        ...
        for (Triple<String,Integer,Integer> trip : triples) {
          System.out.printf("%s over string: <%s> character offsets [%d, %d) in sentence %d.%n",
                  trip.first(), str.substring(trip.second, trip.third) ,trip.second(), trip.third, j);
        }
      }
      System.out.println("---");
/*
